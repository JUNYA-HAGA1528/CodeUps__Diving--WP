                        ...
                        <li class="aside__item aside__item--calc">
                            <div class="campaign-card">
                                ...
                                <div class="campaign-card__body campaign-card__body--calc">
                                    <h3 class="campaign-card__title campaign-card__title--calc"><?php the_title(); ?></h3>
                                    <div class="campaign-card__wrapper campaign-card__wrapper--calc">
                                        <p class="campaign-card__subtitle campaign-card__subtitle--calc">全部コミコミ(お一人様)</p>
                                        <div class="campaign-card__price">
                                            <?php if( have_rows('campaign_price-group') ): the_row(); ?>
                                                ...
                                                <div class="campaign-card__price-before"><?php echo $campaign_price1; ?></div>
                                                <div class="campaign-card__price-after"><?php echo $campaign_price2; ?></div>
                                            <?php endif; ?>
                                        </div>
                                    </div>
                                </div>
