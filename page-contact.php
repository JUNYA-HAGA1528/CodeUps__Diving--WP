...
?> 
    ...
    <section class="contact-fv sub-fv">
        <div class="sub-fv__inner">
            <picture>
                ...
                <img src="<?php echo get_theme_file_uri(); ?>/dist/assets/images/common/privacy-policy_fv_sp.jpg" alt="浜辺">
            </picture>
    ...
    <section class="top-contact-form contact-form fish-logo">
        <div class="contact-form__inner inner">
            <?php echo do_shortcode('[contact-form-7 id="10259fa" title="お問い合わせ"]'); ?>
        </div>
    </section>
<?php get_footer() ;?>